...
// Root directory of the dashboard pages
...
// Main function
function main() {
  console.log('Finding all dashboard page files...');
  ...
  console.log(`\n\x1b[32mSummary: Modified ${modifiedCount} of ${pageFiles.length} dashboard page files.\x1b[0m`);
}
